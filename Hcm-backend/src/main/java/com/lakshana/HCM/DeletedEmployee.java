...
public class DeletedEmployee {
	...
	public DeletedEmployee(long empId, String empName, double salary, char gender, String email, String dob,
			String address, String coreskill, int experienceInYears, Department department) {
		super();
		this.empId = empId;
	...
	public String toString() {
		return "DeletedEmployee [empId=" + empId + ", empName=" + empName + ", salary=" + salary + ", gender=" + gender
